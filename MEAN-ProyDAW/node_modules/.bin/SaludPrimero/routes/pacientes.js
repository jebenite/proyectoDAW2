...
router.post('/', function (req, res) {
  ...
  console.log('I received a post request');
    Usuario.create({cedula:req.body.cedula, user:req.body.correo , password:password, nombres:req.body.nombres, apellidos:req.body.apellidos, rol:"paciente", correo:req.body.correo}, function (err, docs) {
        console.log(docs);
        res.json(docs);
