...
<body>
    ...
    <section class="container containerMin">
        ...
        <button id ="btnNuevoPaciente" class="btn btn-success" onclick = "location='/paciente-crear.ejs'">Nuevo Paciente</button>
    </section>
        ...
        <div class="col-md-8">
            <form id="muestraCreateForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputPaciente" required="" disabled>
                </div>
                <div class="form-group">
                    <label for="inpuPaciente">Apellidos del Paciente</label>
                    <input type="text" class="form-control" id="inputPacienteap" required="" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="inpuLaboratorio">
                        <option selected disabled>-Selecionar-</option>
                    </select>
                </div>
                <div class="form-group">
    ...
    $( ).ready(function() {
        ...
        //Cargar los Pacientes por su cedula.
        var url = "/muestras";
        ...
        $.ajax({
                ...
                success: function(respuesta){
                    ...
                    /*]$("#inpuLaboratorio").change(function(){
                        respuesta.forEach(function(item){
                            if($("#inputcedula").val()==item.cedula){
                                $("#inputPaciente").val(item.nombres); 
                            }
