...
<head>
    ...
    <link href="stylesheets/ingresomuestras.css" rel="stylesheet">
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class=""><a href="listaDeResultados.ejs">Lista de resultados</a></li>
	...
	<script src="javascripts/ingresomuestra.js"></script>
