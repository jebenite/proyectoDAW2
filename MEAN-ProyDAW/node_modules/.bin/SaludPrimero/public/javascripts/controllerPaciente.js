        ...
        var tbl1={
            ...
            var docDefinition = {
              ...
              content: [
                ...
                { text: 'SALUD PRIMERO S.A.', fontSize: 8, bold: true, alignment: 'center', margin: [ 0, 13, 0, 10 ] },
                { text: 'RESULTADOS DE EXAMENES', fontSize: 15, bold: true, alignment: 'center', margin: [ 0, 0, 0, 10 ] },
